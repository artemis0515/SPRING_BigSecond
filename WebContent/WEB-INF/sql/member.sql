...
VALUES('admin', '1111', '관리자', '123-1234', 'admin@mail.com',  
'123-123','서울시', '관철동' ,'A01', sysdate, 'member.jpg', 'A');
...
insert into zipcode values('130-855','서울','동대문구','전농1동','305∼332번지');
insert into zipcode values('130-856','서울','동대문구','전농1동','333∼492');
insert into zipcode values('130-857','서울','동대문구','전농1동','493∼570');
insert into zipcode values('130-859','서울','동대문구','전농1동','622∼683');
insert into zipcode values('130-021','서울','동대문구','전농1동',' ');
insert into zipcode values('130-713','서울','동대문구','전농1동 동아아파트',' ');
insert into zipcode values('130-850','서울','동대문구','전농2동','32∼74번지');
insert into zipcode values('130-851','서울','동대문구','전농2동','96∼103');
insert into zipcode values('130-853','서울','동대문구','전농2동','155∼203');
insert into zipcode values('130-022','서울','동대문구','전농2동',' ');
insert into zipcode values('130-709','서울','동대문구','전농2동 성바오르병원',' ');
insert into zipcode values('130-848','서울','동대문구','전농3동','1∼20번지');
insert into zipcode values('130-849','서울','동대문구','전농3동','21∼31');
insert into zipcode values('130-023','서울','동대문구','전농3동',' ');
insert into zipcode values('130-770','서울','동대문구','전농3동 삼성아파트',' ');
insert into zipcode values('130-743','서울','동대문구','전농3동 서울시립대학교',' ');
insert into zipcode values('130-769','서울','동대문구','전농3동 선경아파트',' ');
insert into zipcode values('130-771','서울','동대문구','전농3동 우성아파트',' ');
insert into zipcode values('130-852','서울','동대문구','전농4동','104∼129번지');
insert into zipcode values('130-854','서울','동대문구','전농4동','204∼304');
insert into zipcode values('130-858','서울','동대문구','전농4동','571∼608');
insert into zipcode values('130-024','서울','동대문구','전농4동',' ');
insert into zipcode values('130-020','서울','동대문구','전농동',' ');
 
   SELECT zipcode, sido, gugun, dongli, etc 
   FROM zipcode 
   WHERE (dongli LIKE '%전농3동%') 
